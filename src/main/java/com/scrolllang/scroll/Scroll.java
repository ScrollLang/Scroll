...
import com.scrolllang.scroll.elements.Types;
import com.scrolllang.scroll.exceptions.EmptyStacktraceException;
import com.scrolllang.scroll.language.ScrollEvent;
import com.scrolllang.scroll.log.ExceptionPrinter;
import com.scrolllang.scroll.utils.FileUtils;
...
public class Scroll extends SkriptAddon implements ModInitializer {
	...
	static void register() {
		...
		new Reflections(
				"com.scrolllang.scroll.commands",
				"com.scrolllang.scroll.elements",
